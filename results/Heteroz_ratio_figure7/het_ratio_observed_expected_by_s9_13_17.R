...
setwd("evotech/nearly-neutral/data/9_13_17fixed/")   # Maybe won't work, but shows the right directory
...
s_neut=subset(s_all,type=="N",select=c(s,N,ave_heteroz,expected_heteroz_ratio,ave_innov_count,observed_heteroz_ratio,count_ratio))
s0005=subset(s_all,s==-0.0005,select=c(s,N,ave_heteroz,expected_heteroz_ratio,ave_innov_count,observed_heteroz_ratio,count_ratio))
s001=subset(s_all,s==-0.001,select=c(s,N,ave_heteroz,expected_heteroz_ratio,ave_innov_count,observed_heteroz_ratio,count_ratio))
s002=subset(s_all,s==-0.002,select=c(s,N,ave_heteroz,expected_heteroz_ratio,ave_innov_count,observed_heteroz_ratio,count_ratio))
s005=subset(s_all,s==-0.005,select=c(s,N,ave_heteroz,expected_heteroz_ratio,ave_innov_count,observed_heteroz_ratio,count_ratio))
s01=subset(s_all,s==-0.01,select=c(s,N,ave_heteroz,expected_heteroz_ratio,ave_innov_count,observed_heteroz_ratio,count_ratio))
s02=subset(s_all,s==-0.02,select=c(s,N,ave_heteroz,expected_heteroz_ratio,ave_innov_count,observed_heteroz_ratio,count_ratio))
...
#sss = setNames(s005, names(s005)); legend_right=30; legend_max = 0.3;
